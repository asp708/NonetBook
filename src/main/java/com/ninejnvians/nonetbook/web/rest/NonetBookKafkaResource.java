...
@RestController
@RequestMapping("/api/nonet-book-kafka")
public class NonetBookKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NonetBookKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NonetBookKafkaResource(KafkaProperties kafkaProperties) {
